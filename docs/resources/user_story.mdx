...
UserStory is used to synchronize data between AniAPI and external Anime's tracking systems.
...
#### synced <Highlight bgColor="#8D46B8" color="white" content="bool" />

Indicates if an UserStory has been synced with User's linked trackers.
