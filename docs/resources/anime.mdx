...
#### titles <Highlight bgColor="#8D46B8" color="white" content="array of strings" />

A collection of the show's titles organized by localization.

---

#### descriptions <Highlight bgColor="#8D46B8" color="white" content="array of strings" />

A collection of the show's descriptions organized by localization.
